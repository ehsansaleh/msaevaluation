...
5) Step3.01.bash		==> Aligning sequences of Step2.bash using MAFFT G-INS-I
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/GINSIAlignments/"NucleicOrAmino"Acids/"Database"
					
6) Step3.02.bash		==> Aligning sequences of Step2.bash using MAFFT E-INS-I
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/EINSIAlignments/"NucleicOrAmino"Acids/"Database"
					
7) Step3.03.bash		==> Aligning sequences of Step2.bash using MAFFT L-INS-I
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/LINSIAlignments/"NucleicOrAmino"Acids/"Database"
					
8) Step3.1.bash		==> Aligning sequences of Step2.bash using Muscle
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/MuscleAlignments/"NucleicOrAmino"Acids/"Database"
					
9) Step3.2.bash		==> Aligning sequences of Step2.bash using ClustalW
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/ClustalWAlignments/"NucleicOrAmino"Acids/"Database"

10) Step3.4.bash	==> Aligning sequences of Step2.bash using Prank
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/PrankAlignments/"NucleicOrAmino"Acids/"Database"

11) Step3.5.bash	==> Aligning sequences of Step2.bash using ContrAlign v1.04
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/ContralignV104DefaulAlignments/"NucleicOrAmino"Acids/"Database"

12) Step3.6.bash	==> Aligning sequences of Step2.bash using Di-Align
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/DiAlignAlignments/"NucleicOrAmino"Acids/"Database"

12) Step3.7.bash	==> Aligning sequences of Step2.bash using K-Align
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/KAlignAlignments/"NucleicOrAmino"Acids/"Database"

13) Step3.8.bash	==> Aligning sequences of Step2.bash using ProbAlign
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/ProbAlignAlignments/"NucleicOrAmino"Acids/"Database"

14) Step3.9.bash	==> Aligning sequences of Step2.bash using Prime
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/PrimeAlignments/"NucleicOrAmino"Acids/"Database"

15) Step3.x21.bash	==> Aligning sequences of Step2.bash using ProbCons
					Input of Step 3 is: 
						Datasets/SampledAndRenamedAndUnaligned/"NucleicOrAmino"Acids/"Database"
					Output of Step 3 is: 
						ProcessedData/DefaultProbConsAlignments/"NucleicOrAmino"Acids/"Database"
					
16) Step3.x3-submit.bash,
...
17) Step4.bash		==> Creating a table to feed baliphy with protein substitution model information for each dataset 
...
18) Step4.1.bash	==> Creating a table to feed StatAlign with protein substitution model information for each dataset
					(a.k.a. Finding the best model of evolution for each dataset, 
...
19) Step8.bash		==> This step assesses the accuracy of all the estimated alignments and gives you one 
...
```
		A) AICProtModel.py				==> This script gets an alignment as an input, a list of protein substitution model names compatible 
		...
		B) ESSScript.py					==> This script takes as an input the location of the "Report" file generated by baliphy package's 
		...
		C) FastSPMoreStat.py			==> This script is a wrapper for running and reporting results of a benchmark alignments assessment 
											using FastSP. This python script is used within "step8.bash" script.
							
		D) UpdateStats.py				==> This script is very like FastSPMoreStat.py, but it updates an already generated csv file with 
		...
		E) NewManyCsvToOne.py			==> This script concatenates multiple csv files and generates one united csv file.
